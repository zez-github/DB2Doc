...
### 功能介绍
数据库文档管理器提供了强大的文档浏览和搜索功能，帮助您高效管理和查询数据库文档。

### 访问文档管理器
1. 在Web界面顶部导航栏中，点击"数据库文档管理器"选项卡
2. 进入文档管理器界面
...
1. 在左侧搜索结果列表中点击任意条目
2. 右侧详情面板将显示完整信息
3. 支持查看表结构、字段详情、约束信息等

### 高级功能
1. **视图模式切换**：点击工具栏中的视图切换按钮
2. **全屏模式**：点击全屏按钮进入沉浸式查看体验
3. **导出结果**：将搜索结果导出为文件
